...
<head>
    ...
    <!-- Datatable css -->
    <link href="{{ asset('assets2/vendor/datatables.net-bs5/css/dataTables.bootstrap5.min.css') }}" rel="stylesheet"
        type="text/css" />

    <!-- Responsive DataTables CSS -->
    <link href="{{ asset('assets2/vendor/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css') }}"
        rel="stylesheet" type="text/css" />

    <!-- Theme Config Js -->
    <script src="{{ asset('assets2/js/hyper-config.js') }}"></script>

    <!-- App css -->
    <link href="{{ asset('assets2/css/app-saas.min.css') }}" rel="stylesheet" type="text/css" id="app-style" />
...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="topbar container-fluid">
                <div class="d-flex align-items-center gap-lg-2 gap-1">
                    ...
                    <div class="logo-topbar">
                        <!-- Logo light -->
                        <a href="{{ route('product.index') }}" class="logo-light">
                            <span class="logo-lg">
                        ...
                        <!-- Logo Dark -->
                        <a href="{{ route('product.index') }}" class="logo-dark">
                            <span class="logo-lg">
                                <img src="{{ asset('assets2/images/logo-dark.png') }}" alt="dark logo">
                            </span>
                            <span class="logo-sm">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle"
                                            src="{{ asset('assets2/images/users/avatar-2.jpg') }}"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="d-flex">
                                        <img class="d-flex me-2 rounded-circle"
                                            src="{{ asset('assets2/images/users/avatar-5.jpg') }}"
                                            alt="Generic placeholder image" height="32">
                                        <div class="w-100">
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#"
                            role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{ asset('assets2/images/flags/us.jpg') }}" alt="user-image"
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{ asset('assets2/images/flags/germany.jpg') }}" alt="user-image"
                                    class="me-1" height="12"> <span class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{ asset('assets2/images/flags/italy.jpg') }}" alt="user-image"
                            ...
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{ asset('assets2/images/flags/spain.jpg') }}" alt="user-image"
                                    class="me-1" height="12">
                            ...
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{ asset('assets2/images/flags/russia.jpg') }}" alt="user-image"
                                    class="me-1" height="12">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="notify-icon">
                                                    <img src="{{ asset('assets2/images/users/avatar-2.jpg') }}"
                                ...
                                <a href="javascript:void(0);"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="notify-icon">
                                                    <img src="{{ asset('assets2/images/users/avatar-4.jpg') }}"
                                                        class="img-fluid rounded-circle" alt="" />
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                            ...
                            <div class="p-2">
                                <div class="row g-0">
                                    ...
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets2/images/brands/github.png') }}"
                                                alt="Github">
                                            <span>GitHub</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets2/images/brands/dribbble.png') }}"
                                                alt="dribbble">
                                            <span>Dribbble</span>
                                        </a>
                                    </div>
                                ...
                                <div class="row g-0">
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets2/images/brands/bitbucket.png') }}"
                                                alt="bitbucket">
                                            <span>Bitbucket</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets2/images/brands/dropbox.png') }}"
                                                alt="dropbox">
                                            <span>Dropbox</span>
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a class="dropdown-icon-item" href="#">
                                            <img src="{{ asset('assets2/images/brands/g-suite.png') }}"
                                                alt="G Suite">
                                            <span>G Suite</span>
                                        </a>
                                    </div>
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown"
                            ...
                            <span class="account-user-avatar">
                                <img src="{{ asset('assets2/images/users/avatar-1.jpg') }}" alt="user-image"
        ...
        <div class="leftside-menu">
            ...
            <!-- Brand Logo Light -->
            <a href="{{ route('product.index') }}" class="logo logo-light">
                <span class="logo-lg">
                    <img src="{{ asset('assets2/images/logo.png') }}" alt="logo">
                </span>
                <span class="logo-sm">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <div class="leftbar-user">
                    <a href="pages-profile.html">
                        <img src="{{ asset('assets2/images/users/avatar-1.jpg') }}" alt="user-image" height="42"
