...
<!-- Vendor js -->
<script src="{{ asset('asset2/js/vendor.min.js') }}"></script>

<!-- Datatable js -->
<script src="{{ asset('asset2/vendor/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('asset2/vendor/datatables.net-bs5/js/dataTables.bootstrap5.min.js') }}"></script>
<script src="{{ asset('asset2/vendor/datatables.net-responsive/js/dataTables.responsive.min.js') }}"></script>
<script src="{{ asset('asset2/vendor/datatables.net-responsive-bs5/js/responsive.bootstrap5.min.js') }}"></script>
<script src="{{ asset('asset2/vendor/jquery-datatables-checkboxes/js/dataTables.checkboxes.min.js') }}"></script>

<!-- Product Demo App js -->
<script src="{{ asset('asset2/js/pages/demo.products.js') }}"></script>

<!-- App js -->
<script src="{{ asset('asset2/js/app.min.js') }}"></script>
</body>

<!-- Mirrored from coderthemes.com/hyper/saas/apps-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Jul 2023 10:18:42 GMT -->
