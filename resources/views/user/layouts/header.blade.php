...
<body>
                ...
                <div class="col-12">
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div class="header_contact_info">
                            <ul class="d-flex">
                                <li class="text-white"> <i class="icons icon-phone"></i>
                                    <a href="tel:+84328548878">0328548878</a>
                                </li>
                                <li class="text-white"> <i class="icon-envelope-letter icons"></i> <a
                                        href="#">phananh.main@gmail.com</a></li>
                            </ul>
                        </div>
    ...
    <header class="header_section header_transparent">
                            ...
                            <div class="header_contact_info">
                                <ul class="d-flex">
                                    <li class="text-white"> <i class="icons icon-phone"></i> <a
                                            href="tel:+84328548878">0328548878</a></li>
                                    <li class="text-white"> <i class="icon-envelope-letter icons"></i> <a
                                            href="#">phananh.main@gmail.com</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="header_container d-flex justify-content-between align-items-center">
                            ...
                            <div class="header_logo">
                                <a class="sticky_none" href="/home"><img src="assets/img/logo/logo.png"
                                        alt=""></a>
                            </div>
                            <!--main menu start-->
                                    ...
                                    <ul class="d-flex">
                                        ...
                                        <li><a href="#">Quần nam</a>
                                            <ul class="sub_menu">
                                                ...
                                                <li><a href="/single_product/4">Quần Tây</a></li>
                                            </ul>
                                        </li>
        ...
        <!-- page search box -->
        <div class="page_search_box"> {{-- thêm active vào trong class này là bấm đc tìm kiếm --}}
